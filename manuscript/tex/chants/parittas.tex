...
\begin{packeditemize}
  ...
  \item the third bhikkhu in seniority chants the invitation to the devas
...
(\thai{สิบสองตํานาน}) contains S1-S12. Presently the custom is that chants
can be added to both sequences. The order of the chants is usually kept as
follows.
...
\begin{tabular}{@{}l l r r@{}}
  ...
  & Bāhuṃ sahassam-abhinimmita & S12 & \pageref{bahum} \\
  & Mahā-kāruṇiko nātho & & \pageref{maha-karuniko} \\
...
\textbf{Karaṇīyam-attha-kusalena:} This is not included when chanting in lay
people's houses, except as part of a funeral ceremony.
...
\firstline{Sabbītiyo vivajjantu}
