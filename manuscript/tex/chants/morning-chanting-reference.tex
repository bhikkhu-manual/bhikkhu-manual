...
\begin{leader}
  [Now let us chant our salutation to the Triple Gem and a passage \\to arouse urgency.]
\end{leader}
...
Attentively we follow the pathway of that Blessed One, with \prul{all} of \\our mindfulness and strength.\\
