...
% FIXME title too similar to 'Puññass'idāni katassa'
...
\begin{leader}
  ...
  \todo{very similar to the other reflection on the requisites, review punctuation}
\end{leader}
...
% FIXME: title too similar to 'Yā devatā santi vihāra-vāsinī'

\firstline{Puññass'idāni katassa yān'aññāni katāni me}

\begin{leader}
  [Handa mayaṃ sabba-patti-dāna-gāthāyo bhaṇāmase]%
  \todo{Title is the same as with ‘Yā devatā\ldots’ above}
\end{leader}
