...
Namo vimuttānaṃ, namo vimuttiyā.\\
Imaṃ so parittaṃ katvā,\\
Moro vāsam-akappayī'ti. \suttaRef{J.159}
...
Loma-haṃso na hessatī-ti. \suttaRef{S.I.219-220}% TODO Confirm Pali source
\end{paritta}
...
{\centering
  \instr{The \emph{djet-damnahn} sequence ends here\\ and continues with the closing sequence.}
\par}
...
{\centering
  \instr{The \emph{sipsong-damnahn} sequence ends here\\ and continues with the closing sequence.}
\par}
...
{\centering
  \instr{(If started with \emph{Vipassissa\ldots}, continue below\\
