...
% TODO rephrase: three formulae, two in the presence of, one in the abscence of
...
If more than one article is to be shared substitute the plural form as in case 1 above.
